...
namespace PharmacyUnitTest
{
    public  class AdminControllerTest
    {
        ...
        private IRepository<int, Cart> _cartRepo;
        private CustomerJoinedRepository _customerRepo;
        private IRepository<int, Order> _orderRepo;
        private IRepository<int, OrderDetail> _orderDetailRepo;
        private AdminService _adminService;
        private ICartService _userService;
        private IRepository<int, Stock> _stockRepo;
        ...
        private IRepository<int, DeliveryDetail> _deliveryDetailRepo;
