...
namespace PharmacyUnitTest
{
    ...
    public class UserServiceTests
    {
        ...
        public async Task AddToCartFail()
        {
            ...
            var exception = Assert.ThrowsAsync<OutOfStockException>(async () => await _userService.AddToCart(addToCart));
        ...
        public async Task AddToCartDuplicateFail()
        {
           ...
           await _userService.AddToCart(addToCart);
            ...
            var exception = Assert.ThrowsAsync<DuplicateValueException>(async () => await _userService.AddToCart(newaAdToCart));
        ...
        public async Task UpdateCart()
        {
            ...
            var result = await _userService.UpdateCart(newaAdToCart);
        ...
        public async Task UpdateCartFail()
        {
            ...
            var exception = Assert.ThrowsAsync<NoCartFoundException>(async () => await _userService.UpdateCart(newaAdToCart));
        ...
        public async Task UpdateCartQuantityFail()
        {
           ...
           await _userService.AddToCart(addToCart);
            ...
            var exception = Assert.ThrowsAsync<OutOfStockException>(async () => await _userService.UpdateCart(newAddToCart));
            Assert.That(exception.Message, Is.EqualTo("Expected Quantity is not avalable in the stock"));
        ...
        public async Task RemoveFromCart()
        {
            ...
            await _userService.AddToCart(addToCart);
            var result = await _userService.RemoveFromCart(1);
            Assert.That(result.CartId, Is.EqualTo(1));
            Assert.Pass();
        ...
        public async Task RemoveFromCartFail()
        {
            ...
            var exception = Assert.ThrowsAsync<NoCartFoundException>(async () => await _userService.RemoveFromCart(1));
        ...
        public async Task CartCheckout()
        {
            ...
            await _userService.AddToCart(newAddToCart);
            var result = await _userService.Checkout(1);
        ...
        public async Task CartCheckoutFailWithQuantity()
        {
            ...
            var exception = Assert.ThrowsAsync<OutOfStockException>(async () => await _userService.Checkout(1));
        ...
        public async Task CartCheckoutFailWithNoCart()
        {
            ...
            await _userService.AddToCart(addToCart);
           await _userService.RemoveFromCart(1);

            var exception = Assert.ThrowsAsync<CartEmptyException>(async () => await _userService.Checkout(1));
        ...
        public async Task GetAllMyOrder()
        {
            ...
            await _userService.AddToCart(newAddToCart);    
            await _userService.Checkout(1);
            await _adminService.DeliverOrder(1);
            var result = await _userService.GetAllOrders(1);
